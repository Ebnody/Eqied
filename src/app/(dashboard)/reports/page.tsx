    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass rounded-2xl border border-white/10 p-4">
          <p className="text-xs text-slate-400">{t("common.remaining")}</p>
          <p
            className={`mt-1 text-xl font-semibold ${
              monthly.remaining < 0 ? "text-rose-400" : "text-white"
            }`}
          >
        ...
        <div className="glass rounded-2xl border border-white/10 p-4">
          <p className="text-xs text-slate-400">{t("reports.savingsRate")}</p>
          <p
            className={`mt-1 text-xl font-semibold ${
      ...
      <div className="glass rounded-2xl border border-white/10 p-5">
        <div className="flex items-end justify-between flex-wrap gap-2 mb-3">
          <div>
            <h2 className="font-semibold text-slate-100">{t("reports.today")}</h2>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="glass rounded-2xl border border-white/10 p-5">
          <h2 className="font-semibold text-slate-100 mb-1">{t("reports.last6Months")}</h2>
          <p className="text-xs text-slate-500 mb-4">{t("reports.last6MonthsSub")}</p>
          <MonthOverMonthChart data={mom} />
        </div>

        <div className="glass rounded-2xl border border-white/10 p-5">
          <h2 className="font-semibold text-slate-100 mb-1">{t("reports.netTrend")}</h2>
      ...
      {plannedVsActual.length > 0 && (
        <div className="glass rounded-2xl border border-white/10 p-5">
          <h2 className="font-semibold text-slate-100 mb-1">{t("reports.plannedVsActual")}</h2>
      ...
      {/* Detailed list */}
      <div className="glass rounded-2xl border border-white/10 p-5">
        <h2 className="font-semibold text-slate-100 mb-2">{t("reports.byCategory")}</h2>
        {sorted.length === 0 ? (
